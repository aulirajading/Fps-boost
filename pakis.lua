--[[
    ...
    Fitur:
    - Freecam (J) - Kontrol: Space = Maju | Ctrl = Mundur | F = Kiri | G = Kanan | E = Naik | Q = Turun
...
local function startFreecam()
    ...
    print("[CVAI] Freecam ON - Kontrol: Space = Maju | Ctrl = Mundur | F/G = Kiri/Kanan | E/Q = Naik/Turun")
end
