--[[
    CVAI COMPLETE - NO FREEZE VERSION (Safe)
    Fitur:
    - Freecam (J) - WASD gerak kamera, karakter DIAM ALAMI (tanpa freeze)
...
local function startFreecam()
    ...
    print("[CVAI] Freecam ON - Karakter tetap di tempat (tidak di-freeze)")
end
...
print("[CVAI] ========== NO FREEZE VERSION (SAFE) ==========")
print("[CVAI] J = Freecam (Karakter TIDAK di-freeze - lebih aman)")
